...
export const tasksReducer = (state: TasksState, {type, payload}: ActionsType) => {
    switch (type) {
        case 'REMOVE-TASK': {
...
type ActionsType = RemoveTaskActionType | AddTaskActionType | ChangeTaskStatusActionType | AddTodolistActionType
