...
function AppWithReducers() {
    ...
    const changeTaskStatus = (taskId: string, taskStatus: boolean, todolistId: string) => {
        dispatchTasks(changeTaskStatusAC({taskID: taskId, todolistID: todolistId, isDone: taskStatus}))
    }
    ...
    const updateTask = (todolistId: string, taskId: string, newTitle: string) => {
        dispatchTasks(changeTaskTitleAC({todolistID: todolistId, taskID: taskId, title: newTitle}))
    }
